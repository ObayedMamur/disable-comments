...
# Skip branch creation — spec directories live in specs/ independent of git branches.
# This allows creating multiple specs on the same branch.
>&2 echo "[specify] Creating spec directory for $BRANCH_NAME (no branch checkout)"
